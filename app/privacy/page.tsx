...
export const metadata = {
  ...
  description: "Как Архим (mr.Kcopoc) использует и хранит персональные данные посетителей."
};
  ...
  return (
    <main className="mx-auto max-w-content space-y-6 px-4 py-16 text-sm text-muted sm:px-6">
      ...
      <section className="space-y-4 rounded-3xl border border-outline/60 bg-surface/60 p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-white">Что собираем</h2>
      ...
      <section className="space-y-4 rounded-3xl border border-outline/60 bg-surface/60 p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-white">Как используем</h2>
        <ul className="list-disc space-y-2 pl-6">
      ...
      <section className="space-y-4 rounded-3xl border border-outline/60 bg-surface/60 p-6 shadow-lg">
        <h2 className="text-xl font-semibold text-white">Хранение и удаление</h2>
        <p>
